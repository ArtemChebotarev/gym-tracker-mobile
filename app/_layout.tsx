...
//
// `ThemeProvider` gives every stack the app's dark page as its background — see `navigationTheme`
// in components/RootLayoutStyles.ts for the white flash it stops.
