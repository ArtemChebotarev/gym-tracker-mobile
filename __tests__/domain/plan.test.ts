...
import type { MesoTemplate, SessionWithExercises, WeekPlan, WeekPlanDay, WeekPlanExercise } from '@domain/plan';
import { extractWeekPlan, materializeWeekPlan } from '@domain/plan';
